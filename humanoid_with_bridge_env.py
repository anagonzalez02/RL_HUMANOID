...
class HumanoidOnBridge(HumanoidEnv):
    def __init__(self, lateral_penalty=0.05, k_prog=100.0, k_fwd=5.0, frame_skip=5, **kwargs):
        xml_file = os.path.join(os.path.dirname(__file__), "humanoid_with_bridge.xml")
